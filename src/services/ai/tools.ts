      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            text: { type: SchemaType.STRING, description: "Text to append." },
          },
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            sheetName: { type: SchemaType.STRING, description: "Sheet name." },
            values: {
              type: SchemaType.ARRAY,
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            sheetName: { type: SchemaType.STRING, description: "Sheet name." },
            cell: { type: SchemaType.STRING, description: "Cell (e.g., A1)." },
